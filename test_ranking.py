...
def get_subgraphs(all_links, adj_list, dgl_adj_list, max_node_label_value, id2entity, node_features=None, kge_entity2id=None):
    ...
    for link in all_links:
        ...
        try:
            ...
            # rel_link = np.nonzero(subgraph.edata['type'][edges_btw_roots] == r_labels)
        except:
...
def main(params):
    ...
    for idx, link in tqdm(enumerate(neg_triplets), total=len(neg_triplets)):
        # if idx != 408:
        #     continue
...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiment_name", "-e", type=str, default="grail_nell_v1",
